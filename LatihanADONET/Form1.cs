    ...
    public partial class Form1 : Form
    {
        ...
        private OleDbConnection GetOpenConnection()
        {
            ...
            try // penggunaan blok try-catch untuk penanganan error
            {
                ...
                string dbName = @"D:\Tugas Sekolah\UNIVERSITAS AMIKOM YOGYAKARTA\semester 3\pempro lanjut\LatihanADO.NET\Database\DbPerpustakaan.mdb";
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (result > 0)
            {
                MessageBox.Show("Apakah Data mahasiswa ingin dihapus ?", "Informasi", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
                ...
                MessageBox.Show("Data mahasiswa tidak terhapus !!!", "Informasi", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
